...
const translations = {
  en: { signIn: "Sign In", signInSub: "Welcome back.", emailLabel: "EMAIL", passLabel: "PASSWORD", newHere: "New here?", createAccount: "Create account", registration: "Registration", regSub: "Join us.", fullName: "FULL NAME", university: "UNIVERSITY", course: "COURSE", backBtn: "Back", btnCreate: "Create", alertSuccess: "Success! Sign in now." },
  mr: { signIn: "प्रवेश करा", signInSub: "स्वागत आहे.", emailLabel: "ईमेल", passLabel: "पासवर्ड", newHere: "नवीन आहात?", createAccount: "खाते तयार करा", registration: "नोंदणी", regSub: "सहभागी व्हा.", fullName: "पूर्ण नाव", university: "विद्यापीठ", course: "कोर्स", backBtn: "परत", btnCreate: "तयार करा", alertSuccess: "यशस्वी!" },
  hi: { signIn: "साइन इन", signInSub: "स्वागत है।", emailLabel: "ईमेल", passLabel: "पासवर्ड", newHere: "नए हैं?", createAccount: "खाता बनाएं", registration: "पंजीकरण", regSub: "जुड़ें।", fullName: "पूरा नाम", university: "विश्वविद्यालय", course: "कोर्स", backBtn: "वापस", btnCreate: "बनाएं", alertSuccess: "सफल!" }
};
  ...
  const handleAction = async (e) => {
    ...
    if (step === 1) {
      try {
        ...
        // Store EXACT data from DynamoDB
    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#020617] p-6">
      <div className="w-full max-w-md bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-10">
          ...
          {step === 1 ? (
            <form onSubmit={handleAction} className="space-y-5 animate-in fade-in slide-in-from-bottom-4">
              ...
              <button type="submit" disabled={loading} className="w-full p-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold rounded-xl flex items-center justify-center gap-2">
            ...
            <form onSubmit={handleAction} className="space-y-4 animate-in fade-in slide-in-from-bottom-4">
              <button onClick={() => setStep(1)} className="text-sm text-gray-400 flex items-center gap-1"><ChevronLeft size={14}/> {t.backBtn}</button>
